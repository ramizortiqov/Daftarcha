...
class CalculatorViewModel @Inject constructor(
    ...
    fun calculateSelectedProjects() {
        viewModelScope.launch {
            ...
            val totalPayments = paymentDao.getTotalPaymentsForProjectList(projectIds)
            // Кассада қолган пул: тушган пул минус рабочиларга берилган пул (payment,
            // "Пул берди"дан тарқатилгани ва алоҳида берилгани ҳам) минус харажатлар.
            // Кассада пул етмаса — манфий бўлиши мумкин.
